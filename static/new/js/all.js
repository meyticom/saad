...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"در حال پردازش",sLengthMenu:"در حال نمایش _MENU_ ورودی ها",sZeroRecords:"یافت نشد . ",sZeroRecords:"No matching records",
sLoadingRecords:"در حال دریافت اطلاعات",sInfo:"در حال نمایش _START_ تا _END_ از _TOTAL_ ورودی ها",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(یافت شد _MAX_ تمام ورودی ها)",sInfoPostFix:"",sInfoThousands:",",sSearch:"جستجو :",sUrl:"",oPaginate:{sFirst:"نخست",sPrevious:"قبلی",sNext:"بعدی",sLast:"آخرین"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "email": {
                    ...
                    "alertText": " آدرس ایمیل معتبر نیست"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
